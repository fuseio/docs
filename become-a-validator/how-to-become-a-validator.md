...
[Any entity that is holding the Fuse token can run a node](../the-fuse-chain/consensus-contracts/stake-delegate-and-withdraw.md#stake) that approves transaction in the network and in doing so receive rewards in the form of Fuse token \(FUSE\).
